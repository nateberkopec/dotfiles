require "time"
%w[versions sources release_notes_upstream release_notes manifests candidates changed_pins report report_evidence report_checks lock_provenance transport].each do |name|
