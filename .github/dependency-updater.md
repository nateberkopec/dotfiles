...
Write a PR646-style report of at most 500 visible words: 3–5 useful linked highlights, a simple Tool / Old / New Updates table, concrete Skipped reasons and Attention for security, uncertainty or manual action. Every highlight needs a repository file or active configuration that receives its benefit; omit unsupported benefits rather than add filler. Account for candidates, gate-clear dates and snooze boundaries concisely. Include applicable migration, rollback, client or configuration actions. Distinguish correctness from vulnerabilities; never claim unrun tests. No ledger or per-package essays; presentation is editorial guidance, not a grammar.
