...
class SetFontSmoothingStepTest < Minitest::Test
  ...
  def test_complete_when_setting_is_zero
    @fake_system.stub_command_output("defaults -currentHost read -g AppleFontSmoothing", "0", exit_status: 0)
  ...
  def test_incomplete_when_setting_differs
    @fake_system.stub_command_output("defaults -currentHost read -g AppleFontSmoothing", "1", exit_status: 0)
