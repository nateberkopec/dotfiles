...
class ConfigureApplicationsStepTest < Minitest::Test
  ...
  def test_complete_when_all_files_match
    step = create_step(Dotfiles::Step::ConfigureApplicationsStep, dotfiles_dir: @real_dotfiles_dir)
    @fake_system.stub_file_content("#{@real_dotfiles_dir}/files/ghostty/config", "ghostty config")
    @fake_system.stub_file_content("/tmp/home/Library/Application Support/com.mitchellh.ghostty/config", "ghostty config")
    @fake_system.stub_file_content("#{@real_dotfiles_dir}/files/aerospace/.aerospace.toml", "aerospace config")
    @fake_system.stub_file_content("/tmp/home/.aerospace.toml", "aerospace config")
    @fake_system.stub_file_content("#{@real_dotfiles_dir}/files/git/.gitconfig", "git config")
  ...
  def test_update_copies_changed_files
    ...
    @fake_system.stub_file_content("#{@real_dotfiles_dir}/files/ghostty/config", "old ghostty")
    @fake_system.stub_file_content("/tmp/home/.aerospace.toml", "updated aerospace")
    @fake_system.stub_file_content("#{@real_dotfiles_dir}/files/aerospace/.aerospace.toml", "old aerospace")
    @fake_system.stub_file_content("/tmp/home/.gitconfig", "updated git")
    @fake_system.stub_file_content("#{@real_dotfiles_dir}/files/git/.gitconfig", "old git")

    step.update

    assert_equal "updated ghostty", @fake_system.filesystem["#{@real_dotfiles_dir}/files/ghostty/config"]
    assert_equal "updated aerospace", @fake_system.filesystem["#{@real_dotfiles_dir}/files/aerospace/.aerospace.toml"]
    assert_equal "updated git", @fake_system.filesystem["#{@real_dotfiles_dir}/files/git/.gitconfig"]
  end
  ...
  def test_update_skips_unchanged_files
    ...
    @fake_system.stub_file_content("#{@real_dotfiles_dir}/files/ghostty/config", "same ghostty")
    @fake_system.stub_file_content("/tmp/home/.aerospace.toml", "same aerospace")
    @fake_system.stub_file_content("#{@real_dotfiles_dir}/files/aerospace/.aerospace.toml", "same aerospace")
    @fake_system.stub_file_content("/tmp/home/.gitconfig", "same git")
    @fake_system.stub_file_content("#{@real_dotfiles_dir}/files/git/.gitconfig", "same git")
