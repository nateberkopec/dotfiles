class Dotfiles::Step::InstallBrewPackagesStep < Dotfiles::Step
  ...
  def install_packages
    ...
    @system.execute(env_command({"HOMEBREW_AUTO_UPDATE_SECS" => "604800", "HOMEBREW_NO_ENV_HINTS" => "1", "HOMEBREW_CASK_OPTS" => cask_opts}, "brew", "bundle", "install", "--file=#{@brewfile_path}"))
  end
